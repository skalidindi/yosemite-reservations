...
This is a simple script to notify when a yosemite campsite is available to book. Supports logging list of campsite availabilities to a csv, and email/SMS notifications.
